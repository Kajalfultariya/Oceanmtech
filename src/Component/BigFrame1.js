                ...
                {item?.length > 0 ? <>
                    ...
                    <div
                        ...
                        style={{
                            ...
                            border: "solid",
                            borderColor: "black",
                            height: item[index]?.height / 4.5,
                            width: item[index]?.width / 4.5,
                            position: "relative",
                            overflow: "hidden",
                        }}
                    >
                        ...
                        {props?.type == "Video" ?
                            <video
                                ...
                                src={props?.vdata}
                                autoPlay
                                poster="/images/w3html5.gif" style={{
                                    height: item[index]?.height / 4.5,
                                    width: item[index]?.width / 4.5,
                                    position: "relative",
                                    overflow: "hidden",
                        ...
                        {data?.logo ? <img
                            ...
                            style={{
                                position: "absolute",
                                top: item[index]?.logo?.posx / 4.5,
                                left: item[index]?.logo?.posy / 4.5,
                                height: item[index]?.logo?.height / 4.5,
                                width: item[index]?.logo?.width / 4.5
                        ...
                        <div style={{
                            position: "absolute",
                            top: item[index]?.social_icon?.posy / 4.5,
                            left: item[index]?.social_icon?.posx / 4.5,
                            height: item[index]?.social_icon?.height / 4.5,
                            width: item[index]?.social_icon?.width / 4.5 - 10,
                            display: "flex",
                            ...
                            {JSON.parse(data?.social_icones).facebook == "1" ?
                                ...
                                <img
                                    ...
                                    // crossOrigin="anonymous"
                                    style={{
                                        height: item[index]?.social_icon?.icon_height / 3.5,
                                        width: item[index]?.social_icon?.icon_width / 3.5,
                                        margintop: `${marsoc[0]}px`,
                                        marginRight: `${marsoc[1]}px`,
                                        marginBottom: `${marsoc[2]}px`,
                                        marginLeft: `${marsoc[3]}px`,
                                    }}
                                    src={facebook}
                                    alt="background" />
                                : <></>}
                                ...
                                if (itemunder?.res_type == "mobile_no1") {
                                    ...
                                    return (
                                        <div
                                            ...
                                            style={{
                                                top: itemunder?.posy / 4.5,
                                                left: itemunder?.posx / 4.5,
                                                fontWeight: "bold",
                                                position: "absolute",
                                                display: "flex",
                                                justifyContent: txaim1,
                                                margintop: `${mar1[0] / 4.5}px`,
                                                marginRight: `${mar1[1] / 4.5}px`,
                                                marginBottom: `${mar1[2] / 4.5}px`,
                                                marginLeft: `${mar1[3] / 4.5}px`,
                                                fontFamily: itemunder?.font_name,
                                                height: itemunder?.height / 4.5,
                                                width: itemunder?.width / 4.5,
                                                color: "#" + itemunder?.text_color,
                                                fontSize: itemunder?.font_size / 2 + "pt"
                                            }}
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                version="1.0"
                                                width={itemunder?.icon_width / 4.5}
                                                height={itemunder?.icon_height / 4.5}
