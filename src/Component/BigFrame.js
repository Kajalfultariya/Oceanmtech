...
import { postsavePostdata } from "../API";
const BigFrame = (props) => {
    ...
    const CollectionSize = item?.length;
    ...
    var txaisoc = ""
    let marsoc = ""
    console.log("icons", item[index]?.social_icon)
    if (data?.social_icones) {
        if (item[index]?.social_icon?.alignment == null) {

        }
        else {
            if (item[index]?.social_icon?.alignment == "L")
                txaisoc = "left"
            if (item[index]?.social_icon?.alignment == "R")
                txaisoc = "right"
            if (item[index]?.social_icon?.alignment == "C")
                txaisoc = "center"
            marsoc = item[index]?.social_icon?.icon_margin.split(',')

        }

    }
    const back = props?.iname ? props?.iname : "https://oceanmtech.b-cdn.net/dmt/event_file/20220225110005-jb4uck.png"
    ...
    const donwnloadRef = () => {
        ...
        {/*    var xhr = new XMLHttpRequest();
        xhr.open("GET", divref.current, true);
        xhr.responseType = "blob";
        xhr.onload = function (e) {
                   var reader = new FileReader();
            reader.onload = function (event) {
                ...
                tag.href = res;
                tag.target = '_blank';
                tag.download = 'absdsfdsfdsfsd.mp4';
    ...
    */}
        ...
        imgref.current.src = imageUrl1;
        if (data?.logo)
            logoref.current.src = imageUrl2;
        divref.current.style.backgroundImage = 'url(' + imageUrl + ')'


        if (props?.type == "Video") {
            alert("Working On Video")
            /*  videoref.current.src = " "
  
              
              var link = document.createElement("a");
              html2canvas(divref.current, { allowTaint: true }).then(function (canvas) {
                 ...
                 xhr.onload = function (e) {
                     ...
                     reader.onload = function (event) {
                         ...
                         html2canvas(divref.current, { allowTaint: true }).then(function (canvas) {
                             ...
                             document.body.appendChild(link);
                             link.download = "downloadFrame.mp4";
                             link.href = canvas.toDataURL();
                             link.target = '_blank';
                             link.click();
    ...
    const saveDownloadFrame = async (frame) => {
        ...
        formData.append("data_id", localStorage.getItem("BusinessId"))
        formData.append("frame_id", item[index]?.id)
        formData.append("data_file", frame)
        formData.append("unique_id", "test");
        formData.append("type", "Image");

        console.log("id,frame,id", item, item[index]?.id)
        //save frame api
        const response = await postsavePostdata(formData);
        console.log("save download frame post", response)
            ...
            <div
                ...
                {item?.length > 0 ? <>
                    ...
                    <div
                        ref={divref}
                        style={{
                            backgroundImage: props?.type == "Image" ? 'url(' + back + ')' : " ",
                            ...
                            border: "solid",
                            borderColor: "black",
                            height: item[index]?.height / 2.57,
                            width: item[index]?.width / 2.56,
                            position: "relative",
                            overflow: "hidden",
                        }}
                    >
                        ...
                        {data?.logo ? <img
                            ...
                            style={{
                                position: "absolute",
                                top: item[index]?.logo?.posx / 2.57,
                                left: item[index]?.logo?.posy / 2.57,
                                height: item[index]?.logo?.height / 2.57,
                                width: item[index]?.logo?.width / 2.57
                        ...
                        <div style={{
                            position: "absolute",
                            top: item[index]?.social_icon?.posy / 2.57,
                            left: item[index]?.social_icon?.posx / 2.57,
                            height: item[index]?.social_icon?.height / 2.57,
                            width: item[index]?.social_icon?.width / 2.57 - 10,
                            display: "flex",
                            ...
                            {JSON.parse(data?.social_icones).facebook == "1" ?

                                <img
                                    referrerPolicy="no-referrer"
                                    // crossOrigin="anonymous"
                                    style={{
                                        height: item[index]?.social_icon?.icon_height / 2.57,
                                        width: item[index]?.social_icon?.icon_width / 2.57,
                                        margintop: `${marsoc[2] / 2.57}px`,
                                        marginRight: `${marsoc[1] / 2.57}px`,
                                        marginBottom: `${marsoc[3] / 2.57}px`,
                                        marginLeft: `${marsoc[0] / 2.57}px`,
                                    }}
                                    src={facebook}
                                    alt="background" />
                                : <></>}
                            {JSON.parse(data?.social_icones).twitter == "1" ?
                                ...
                                <img
                                    ...
                                    alt="background" />
                                : <></>}
                            {JSON.parse(data?.social_icones).instagram == "1" ?
                                ...
                                : <></>}
                            {JSON.parse(data?.social_icones).youtube == "1" ?
                                ...
                                : <></>}
                            {JSON.parse(data?.social_icones).whatsapp_no == "1" ?
                                ...
                                : <></>}
                            {JSON.parse(data?.social_icones).gmail == "1" ?
                                <img
                                    referrerPolicy="no-referrer"
                                    // crossOrigin="anonymous"
                                    style={{
                                    ...
                                    alt="background" />
                                : <></>}
                            {JSON.parse(data?.social_icones).snapchat == "1" ?
                                <img
                                    referrerPolicy="no-referrer"
                                    // crossOrigin="anonymous"
                                    style={{
                                ...
                                : <></>}
                            {JSON.parse(data?.social_icones).pinterest == "1" ?
                        ...
                        {
                            item[index]?.layer?.map((itemunder) => {
                                ...
                                if (itemunder?.res_type == "mobile_no1") {
                                    ...
                                    return (
                                        <div
                                            ...
                                            style={{
                                                top: itemunder?.posy / 2.57,
                                                left: itemunder?.posx / 2.58,
                                                fontWeight: "bold",
                                                position: "absolute",
                                                display: "flex",
                                                justifyContent: txaim1,
                                                margintop: `${mar1[0] / 2.57}px`,
                                                marginRight: `${mar1[1] / 2.57}px`,
                                                marginBottom: `${mar1[2] / 2.57}px`,
                                                marginLeft: `${mar1[3] / 2.57}px`,
                                                fontFamily: itemunder?.font_name,
                                                height: itemunder?.height / 2.57,
                                                width: itemunder?.width / 2.57,
                                                color: "#" + itemunder?.text_color,
                                                fontSize: itemunder?.font_size + "pt"
                                            }}
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                version="1.0"
                                                width={itemunder?.icon_width / 2}
                                                height={itemunder?.icon_height / 2}
                                ...
                                if (itemunder?.res_type == "address1") {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                version="1.0"
                                                width={itemunder?.icon_width / 2.3}
                                                height={itemunder?.icon_height / 2.3}
                                                viewBox="0 0 512.000000 512.000000"
                                                preserveAspectRatio="xMidYMid meet">
                                                <g
                ...
                </> : <p style={{ color: "red", margin: "15px" }}>Not Save Frame</p>}
            </div>

            {props?.iname ?
                <Button variant="outlined" className="download-btn" onClick={() => { donwnloadRef() }}>
