            ...
            {item?.id?
                ...
                >
                    ...
                    {data?.logo ? <img
                        ...
                        style={{
                            position: "absolute",
                            top: item?.logo?.posx / 8,
                            left: item?.logo?.posy / 8,
                            height: item?.logo?.height / 8,
                            width: item?.logo?.width / 8
                    ...
                    <div style={{
                        position: "absolute",
                        top: item?.social_icon?.posy / 8,
                        left: item?.social_icon?.posx / 8,
                        height: item?.social_icon?.height / 8,
                        width: item?.social_icon?.width / 8 - 10,
                        display: "flex",
                        ...
                        {data?.social_icones[12] == "1" ?
                            ...
                            <img
                                ...
                                // crossOrigin="anonymous"
                                style={{
                                    height: item?.social_icon?.icon_height / 8,
                                    width: item?.social_icon?.icon_width / 8,
                                    margintop: `${marsoc[2] / 8}px`,
                                    marginRight: `${marsoc[1] / 8}px`,
                                    marginBottom: `${marsoc[3] / 8}px`,
                                    marginLeft: `${marsoc[0] / 8}px`,
                                }}
                                src={facebook}
                                alt="background" />
                            : <></>}
                            ...
                            if (itemunder?.res_type == "mobile_no1") {
                                ...
                                return (
                                    <div
                                        ...
                                        style={{
                                            top: itemunder?.posy / 8,
                                            left: itemunder?.posx / 8,
                                            fontWeight: "bold",
                                            position: "absolute",
                                            display: "flex",
                                            justifyContent: txaim1,
                                            margintop: `${mar1[0] / 8}px`,
                                            marginRight: `${mar1[1] / 8}px`,
                                            marginBottom: `${mar1[2] / 8}px`,
                                            marginLeft: `${mar1[3] / 8}px`,
                                            fontFamily: itemunder?.font_name,
                                            height: itemunder?.height / 8,
                                            width: itemunder?.width / 8,
                                            color: "#" + itemunder?.text_color,
                                            fontSize: itemunder?.font_size / 3.5 + "pt"
                                        }}
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            version="1.0"
                                            width={itemunder?.icon_width / 8}
                                            height={itemunder?.icon_height / 8}
