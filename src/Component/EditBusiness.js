...
const EditBusiness = (props) => {
    ...
    const records = JSON.parse(localStorage.getItem("BusinessData"))
    ...
    const [desname, setDesname] = useState(records.tagline);
    const [bname, setBname] = useState(records.business_name);
    const [pospol, setPospol] = useState(records.tagline);
    const [fid, setFid] = useState(JSON.parse(records?.social_icones).facebookid);
    const [iid, setIid] = useState(JSON.parse(records?.social_icones).instagramid);
    const [mobile, setMobile] = useState(records.mobile_no);
    const [mobile2, setMobile2] = useState(records.mobile_no_2);
    const [emailP, setEmailP] = useState(records.email);
    const [website, setWebsite] = useState(records.website);
    const [address, setAddress] = useState(records.address);
    const [logo, setLogo] = useState(records.logo);
    const [logo2, setLogo2] = useState(records.business_image)
    const [yname, setYName] = useState(records.name);
    const [catname, setCatname] = useState(records.category_name);
    const [catiddata, setCatiddata] = useState(records.category_id)
    const [profilename, setProfilename] = useState(records.frame_type_name);
    const [profileiddata, setProfileiddata] = useState(records.frame_type_id)
    const [partyname, setPartyname] = useState(records.political_party_name);
    const [partyiddata, setPartyiddata] = useState(records.political_party_id)
    ...
    let btnRef7 = useRef();
    let btnRef8 = useRef();
    const [cou, setCou] = useState(JSON.parse(records?.social_icones).facebook);
    const [cou2, setCou2] = useState(JSON.parse(records?.social_icones).twitter);
    const [cou3, setCou3] = useState(JSON.parse(records?.social_icones).instagram);
    const [cou4, setCou4] = useState(JSON.parse(records?.social_icones).youtube);
    const [cou5, setCou5] = useState(JSON.parse(records?.social_icones).whatsapp_no);
    const [cou6, setCou6] = useState(JSON.parse(records?.social_icones).gmail);
    const [cou7, setCou7] = useState(JSON.parse(records?.social_icones).snapchat);
    const [cou8, setCou8] = useState(JSON.parse(records?.social_icones).pinterest);
    ...
    const saveData = async () => {
        ...
        if (catname) {
            console.log("fbid,instid", fid, iid)
            setLoader(true);
            setLoaderPage(true)
            ...
            formData.append("business_id", records?.id);
            ...
            if (response1?.data) {
                const response = await getFrameData(username, busname, tag, em, webs, adr, mnf, mns, fid, iid, framid,
                    response1?.data?.id);
                console.log("frame api", response)
    ...
    const onBtnLoad = () => {
        ...
        if (JSON.parse(records?.social_icones).facebook == 1) {
    ...
    const onBtnLoad2 = () => {
        ...
        if (JSON.parse(records?.social_icones).twitter == 1) {
            ...
            btnRef2.current.setAttribute("enabled", "enabled");
            setCou2(0);
    ...
    const onBtnLoad3 = () => {
        ...
        if (JSON.parse(records?.social_icones).instagram == 1) {
            btnRef3.current.setAttribute("disabled", "disabled");
            setCou3(1);
            btnRef3.current.disabled = true;

        }
        else {
            btnRef3.current.setAttribute("enabled", "enabled");
            setCou3(0);
    ...
    const onBtnLoad4 = () => {
        ...
        if (JSON.parse(records?.social_icones).youtube == 1) {
            btnRef4.current.setAttribute("disabled", "disabled");
            setCou4(1);
            btnRef4.current.disabled = true;

        }
        else {
            btnRef4.current.setAttribute("enabled", "enabled");
            setCou4(0);
    ...
    const onBtnLoad5 = () => {
        ...
        if (JSON.parse(records?.social_icones).whatsapp_no == 1) {
            btnRef5.current.setAttribute("disabled", "disabled");
            setCou5(1);
            btnRef5.current.disabled = true;

        }
        else {
            btnRef5.current.setAttribute("enabled", "enabled");
            setCou5(0);
    ...
    const onBtnLoad6 = () => {
        ...
        if (JSON.parse(records?.social_icones).gmail == 1) {
            btnRef6.current.setAttribute("disabled", "disabled");
            setCou6(1);
            btnRef6.current.disabled = true;

        }
        else {
            btnRef6.current.setAttribute("enabled", "enabled");
            setCou6(0);
    ...
    const onBtnLoad7 = () => {
        ...
        if (JSON.parse(records?.social_icones).snapchat == 1) {
            btnRef7.current.setAttribute("disabled", "disabled");
            setCou7(1);
            btnRef7.current.disabled = true;

        }
        else {
            btnRef7.current.setAttribute("enabled", "enabled");
            setCou7(0);
    ...
    const onBtnLoad8 = () => {
        ...
        if (JSON.parse(records?.social_icones).pinterest == 1) {
            btnRef8.current.setAttribute("disabled", "disabled");
            setCou8(1);
            btnRef8.current.disabled = true;

        }
        else {
            btnRef8.current.setAttribute("enabled", "enabled");
            setCou8(0);
                ...
                <div className="ac-right">
                            ...
                            {profileiddata === 4 ? " " : <>
                                <div className="business-social-media">
                                    ...
                                    <div className="social-list">
                                        <button value={cou} ref={btnRef} onLoad={onBtnLoad} onClick={onBtnClick}
                                            style={{
                                                border: cou == 1 ? "solid" : " ",
                                        ...
                                        <button value={cou2} ref={btnRef2} onLoad={onBtnLoad2} onClick={onBtnClick2}
                                            style={{
                                                border: cou2 == 1 ? "solid" : " ",
                                                borderWidth: cou2 == 1 ? "2px" : " ",
                                                borderColor: cou2 == 1 ? "#084277" : " "
                                            }}>
                                            <img alt="tweeter" src={tweeter} />
                                        </button>

                                        <button value={cou3} ref={btnRef3} onLoad={onBtnLoad3} onClick={onBtnClick3}
                                            style={{
                                                border: cou3 == 1 ? "solid" : " ",
                                                borderWidth: cou3 == 1 ? "2px" : " ",
                                                borderColor: cou3 == 1 ? "#084277" : " "
                                            }}>
                                            <img src={instagram} />
                                        </button>

                                        <button value={cou4} ref={btnRef4} onLoad={onBtnLoad4} onClick={onBtnClick4}
                                            style={{
                                                border: cou4 == 1 ? "solid" : " ",
                                                borderWidth: cou4 == 1 ? "2px" : " ",
                                                borderColor: cou4 == 1 ? "#084277" : " "
                                            }}>
                                            <img src={youtube} />
                                        </button>

                                        <button value={cou5} ref={btnRef5} onLoad={onBtnLoad5} onClick={onBtnClick5}
                                            style={{
                                                border: cou5 == 1 ? "solid" : " ",
                                                borderWidth: cou5 == 1 ? "2px" : " ",
                                                borderColor: cou5 == 1 ? "#084277" : " "
                                            }}>
                                            <img src={whtzup} />
                                        </button>

                                        <button value={cou6} ref={btnRef6} onLoad={onBtnLoad6} onClick={onBtnClick6}
                                            style={{
                                                border: cou6 == 1 ? "solid" : " ",
                                                borderWidth: cou6 == 1 ? "2px" : " ",
                                                borderColor: cou6 == 1 ? "#084277" : " "
                                            }}>
                                            <img src={mail} />
                                        </button>

                                        <button value={cou7} ref={btnRef7} onLoad={onBtnLoad7} onClick={onBtnClick7}
                                            style={{
                                                border: cou7 == 1 ? "solid" : " ",
                                                borderWidth: cou7 == 1 ? "2px" : " ",
                                                borderColor: cou7 == 1 ? "#084277" : " "
                                            }}>
                                            <img src={snapchat} />
                                        </button>

                                        <button value={cou8} ref={btnRef8} onLoad={onBtnLoad8} onClick={onBtnClick8}
                                            style={{
                                                border: cou8 == 1 ? "solid" : " ",
                                                borderWidth: cou8 == 1 ? "2px" : " ",
                                        ...
                                        {img2.length > 0
                                            ...
                                            (
                                                <img
                                                    ...
                                                    src={records.business_image ?
                                                        records.business_image
                                                        :
                                                        defaultLogo
                                                    }
                                                /* src={(editmode) ?
                    ...
                    >
                        <div className="login-modal">
                            ...
                            <p>{//JSON.parse(localStorage.getItem("LanguageData"))?.app_business_type_sub
                            }
                            </p>
                    ...
                    >
                        ...
                        <div className="search-business">
                            <input
                                ...
                                //{JSON.parse(localStorage.getItem("LanguageData"))?.business_category_search_hint}
